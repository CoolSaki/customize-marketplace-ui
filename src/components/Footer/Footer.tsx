      ...
      <Container className={classes}>
        <div className="main-footer">
          ...
          <div className="copyright">
            | © {new Date().getFullYear()} Unicial
          </div>
        </div>
        <div className="secondary-footer">
          {/* <div className="links">
            <a href="https://unicial.org">{i18n.links.home}</a>
            <a href="https://decentraland.org">{i18n.links.legalInfo}</a>
            <a href="https://decentraland.org">{i18n.links.pressKit}</a>
          ...
          <div className="social-links">
            <a href="https://discord.gg/JEPcm4YD" className="footer-social-btn">
            ...
            <a href="https://github.com/unicial" className="footer-social-btn">
